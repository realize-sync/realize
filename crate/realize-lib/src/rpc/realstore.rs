//! Service definition for RealStoreService
//!
//! This module defines the RealStoreService trait for use with tarpc 0.36.
...
///
/// This is passed to [RealStoreService::configure].
...
/// Tag that identifies [RealStoreService] when connecting.
