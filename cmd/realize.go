...
var (
	...
	deleteDirRegexpArg = flag.String("deletedir-regexp", "", "After deleting the file, delete containing directory if regexp matches")
...
func main() {
	...
	options := realize.Options{
		Delete:          *deleteArg,
		DeleteDirRegexp: *deleteDirRegexpArg,
